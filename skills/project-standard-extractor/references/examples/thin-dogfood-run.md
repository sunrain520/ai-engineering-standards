...
> level: P1 · status: draft · source_kind: owner-confirmed · evidence_tier: cross-project · risk_tag: medium · owner: TBD · last_reviewed: 2026-05-21 · recommended_action: keep-draft

### 适用范围

- APP 端可跨 Android 和 iOS 复用的核心业务逻辑。

### 强制规则

1. 可跨端复用的核心业务逻辑应优先下沉到 KMP 共享层。
2. 平台层只保留 UI 状态组织、平台差异和交互绑定。
...
- `evidence/code-facts.md「EV-APP-001」`
```
